#!/usr/bin/env python3
"""
Creative Automation CLI - Modern GitHub spec-kit inspired interface.

A world-class CLI for creative automation that follows GitHub's design patterns
for developer experience excellence.
...
# Import CLI modules
from .core import CreatimationGroup, CreatimationContext, pass_context, show_welcome
from .commands import generate, validate, workspace, config, cache
from .utils.output import setup_console, error_console
from .plugins import get_plugin_manager, load_plugins, call_hook
